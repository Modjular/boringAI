...
class BoringAI(gym.Env):
    ...
    def __init__(self, env_config):  
        ...
        self.returns = []
        self.steps = []
        self.initial_reward = 1000  # used per episode to keep track of decreasing reward
    ...
    def step(self, action):
        ...
        # Get Action
        if self.allow_break_action:     # switch tools, start digging
        ...
        else:                           # just move forward if no block in front
    ...
    def get_mission_xml(self):
        ...
        tunnel_xml = ''
        for i in range(1, self.tunnel_len):
            random_block = random.choice(self.block_type)
            tunnel_xml += "<DrawBlock x=\'0\' y=\'2\' z=\'" + str(i) + "\' type=\'" + random_block + "\' />"
